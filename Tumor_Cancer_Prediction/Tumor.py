# import libraries
import pandas as pd
### If you are using this code, change the location of the Excel Sheet to the location where it is on your device so that you will be able to run it ###
# load data
df = pd.read_csv(r"C:\Users\Ossama Mahmoud\OneDrive\Desktop\Tumor_Cancer_Prediction\Tumor_Cancer_Prediction\Tumor Cancer Prediction_DataSet.csv")
